package com.kwonees.validators;
...
public class ProductValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (unitsInStock != null && unitsInStock < 0) {
			errors.rejectValue("unitsInStock", "unitsInStock.invalid", "'Unit in stock' must be > 0");
		}
		...
		if(categoryId == -1) {
			errors.rejectValue("category.categoryId", "category.not.selected", "Please select a catetory");
		}
		if(supplierId == -1) {
